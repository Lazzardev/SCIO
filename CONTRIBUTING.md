Contributing to SCIO Core
============================

The SCIO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SCIO Core project, and is not to be
confused with overall SCIO Network Protocol consensus changes.

Whether a pull request is merged into SCIO Core rests with the project merge
...
Patches that change SCIO consensus rules are considerably more involved than
...
Where a patch set proposes to change the SCIO consensus, it must have been
...
The project leader is the release manager for each SCIO Core release.
