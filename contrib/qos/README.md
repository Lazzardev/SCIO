...
This means one can have an always-on sciod instance running, and another local sciod/scio-qt instance which connects to this node and receives blocks from it.
