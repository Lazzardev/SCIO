...
RESOURCES += src/qt/scio.qrc src/qt/scio_locale.qrc

TRANSLATIONS += src/qt/locale/scio_bg.ts \
                src/qt/locale/scio_de.ts \
                src/qt/locale/scio_en.ts \
                src/qt/locale/scio_es.ts \
                src/qt/locale/scio_fi.ts \
                src/qt/locale/scio_fr.ts \
                src/qt/locale/scio_it.ts \
                src/qt/locale/scio_ja.ts \
                src/qt/locale/scio_pl.ts \
                src/qt/locale/scio_pt.ts \
                src/qt/locale/scio_ru.ts \
                src/qt/locale/scio_sk.ts \
                src/qt/locale/scio_sv.ts \
                src/qt/locale/scio_vi.ts \
                src/qt/locale/scio_zh_CN.ts \
                src/qt/locale/scio_zh_TW.ts
