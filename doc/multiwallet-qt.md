...
In order to support loading of multiple wallets in scio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is scio.cpp.
...
Changes to scio.cpp
----------------------
scio.cpp is the entry point into scio-qt, and as such, will require some minor modifications to provide hooks for
