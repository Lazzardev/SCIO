                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SCIO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SCIO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and scio: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSCIO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SCIO Core"), this);
    aboutAction->setStatusTip(tr("Show information about SCIO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SCIO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SCIO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SCIO addresses"));
    ...
    openAction->setStatusTip(tr("Open a SCIO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SCIO Core help message to get a list with possible SCIO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SCIO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SCIO network", "", count));
}
...
{
    QString strTitle = tr("SCIO Core"); // default title
...
/** Creates context menu, its actions, and scios up all the relevant signals for mouse events. */
