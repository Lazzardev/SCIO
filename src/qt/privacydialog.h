...
public:
    ...
    void setZSCIOControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSCIO_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSCIO_clicked();
    void on_pushButtonZSCIOControl_clicked();
