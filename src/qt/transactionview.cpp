                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received SCIO from zSCIO"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSCIO"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSCIO));
