...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SCIO features */
        {"scio", "masternode", &masternode, true, true, false},
        {"scio", "listmasternodes", &listmasternodes, true, true, false},
        {"scio", "getmasternodecount", &getmasternodecount, true, true, false},
        {"scio", "masternodeconnect", &masternodeconnect, true, true, false},
        {"scio", "masternodecurrent", &masternodecurrent, true, true, false},
        {"scio", "masternodedebug", &masternodedebug, true, true, false},
        {"scio", "startmasternode", &startmasternode, true, true, false},
        {"scio", "createmasternodekey", &createmasternodekey, true, true, false},
        {"scio", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"scio", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"scio", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"scio", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"scio", "getmasternodescores", &getmasternodescores, true, true, false},
        {"scio", "mnbudget", &mnbudget, true, true, false},
        {"scio", "preparebudget", &preparebudget, true, true, false},
        {"scio", "submitbudget", &submitbudget, true, true, false},
        {"scio", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"scio", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"scio", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"scio", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"scio", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"scio", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"scio", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"scio", "checkbudgets", &checkbudgets, true, true, false},
        {"scio", "mnsync", &mnsync, true, true, false},
        {"scio", "spork", &spork, true, true, false},
        {"scio", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"scio", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sciod, or the -server option to scio-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> scio-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7777/\n";
}
